...
import { adminactivationreport } from '../../routes/api';
...
const Adminactivationreport = () => {
    ...
    useEffect(() => {
        ...
        const getUserData = async () => {
            await adminactivationreport(postBody).then(response => {
    ...
    return (
        <Container>
            <Typography variant="h5">Admin Activation Report</Typography>
...
export default Adminactivationreport;
