...
function Addslider() {
    ...
    return (
        <Container>
            ...
            <Typography variant="h5">Add Slider <Ptags>(All the field having * are required)</Ptags></Typography>
            {spinner && <Loading />}
                ...
                <ImageList>
                    ...
                    <ImagePreview>
                        {image ? (
                            ...
                            <p>Slider image upload preview will appear here!</p>
                        )}
                    </ImagePreview>
                </ImageList>
            ...
            <FormControl>
                <Buttons variant="contained" id="submitting" type="submit" onClick={(e) => formik.handleSubmit()}>Add Slider</Buttons>
            </FormControl>
        </Container>
    )
}
