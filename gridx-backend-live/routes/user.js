...
router.post('/directreport',(req, res,next) => {
    usercon.directReport(req, res, next);
});

router.post('/binaryreport',(req, res,next) => {
    usercon.binaryReport(req, res, next);
});
...
router.post('/changePassword', (req, res, next) =>{
    usercon.changePassword(req, res,next);
});

router.post('/changePasswordSave',
    ...
    body('otp').not().isEmpty().withMessage("The otp field is required!"),
    body('oldPassword').not().isEmpty().withMessage("The oldPassword field is required!"),
    (req, res,next) => {
        const errors = validationResult(req);
        if (!errors.isEmpty()) {
            ...
            usercon.changePasswordSave(req, res,next);
        }
    },
);
