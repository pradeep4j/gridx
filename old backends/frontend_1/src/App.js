        ...
        <Box sx={{ flexGrow: 1 }}>
            <AppBar position="fixed" open={open}>
                <Toolbar>
                    ...
                    <Typography variant='h5' component="div" sx={{ flexGrow: 1 }}>GRID ECOSYSTEM</Typography>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <Typography component="div" sx={{ flexGrow: 1 }} /*className={`${!userId ? "mystyle" : ""}`} */>Welcome {name}</Typography>
